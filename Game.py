...
while(True):
    ...
    print("TIME REMAINING:", timerem, end ='\t\t')
    print("LIVES:", obj_mando.getMandolife(), end = '\t\t')
    print("COINS:", obj_mando.getMandocoin()+ obj_bullet.getdragonscore(), end ='\t\t')
    print("BULLETS:", 100-bulletcount,end='\t  ' )
    print("DRAGON LIVES:", obj_bullet.getdragonlife())
    ...
    if(char=='f' and obj_mando.getMyDrag()==0):
